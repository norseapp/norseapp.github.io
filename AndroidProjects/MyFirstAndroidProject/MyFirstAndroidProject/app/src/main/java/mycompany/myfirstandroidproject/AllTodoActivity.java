...
public class AllTodoActivity extends Activity {
    // Progress Dialog
    ...
    ArrayList<HashMap<String, String>> todoList;
     ...
     private static String url_all_todos = "http://localhost:81/android_connect/get_all_todos.php";
    // JSON Node names
        ...
        ListView lv = getListView();
            ...
            lv.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
                    ...
                    String tid = ((CheckBox) view.findViewById(R.id.tid)).getText()
                   .toString();
